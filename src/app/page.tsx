...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 selection:bg-violet-500/30 selection:text-violet-200 transition-colors duration-500">
      {/* Background Effects */}
