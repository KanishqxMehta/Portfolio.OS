  ...
  return (
    ...
    >
      ...
      <Input
        ...
        className={cn(
          fieldClass,
          !item.company && "border-red-500/50 focus-visible:border-red-500 focus-visible:ring-red-500/20 text-red-600 dark:text-red-400"
        )}
      />
      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="space-y-1">
          <Input
            ...
            className={cn(
              fieldClass,
              !item.role && "border-red-500/50 focus-visible:border-red-500 focus-visible:ring-red-500/20 text-red-600 dark:text-red-400"
            )}
          />
        </div>
        <div className="space-y-1">
          <Input
            ...
            className={cn(
              fieldClass,
              !item.years && "border-red-500/50 focus-visible:border-red-500 focus-visible:ring-red-500/20 text-red-600 dark:text-red-400"
            )}
          />
        </div>
      </div>
